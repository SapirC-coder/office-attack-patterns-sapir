...
import "./ChatbotContainer.style.scss";

/**
 * Component of a list which include all Components
 * @param {Array} items | database information 
 * @param {String} currentView | "list" or "grid" (showing all fields or not)
 * @param {function} onToggleCurrentView | helper function, that changing the currentView
 */
